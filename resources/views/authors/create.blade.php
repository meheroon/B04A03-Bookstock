...
@section('page_subtitle','Add a new author')
  ...
  <div class="p-6">
    <form action="{{ route('authors.store') }}" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <textarea name="bio" rows="4" class="w-full rounded-lg border-gray-200 focus:border-indigo-500 focus:ring-indigo-500">{{ old('bio') }}</textarea>
